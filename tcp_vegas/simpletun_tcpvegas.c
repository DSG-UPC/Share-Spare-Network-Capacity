...
int main(int argc, char *argv[]) {
  ...
  int sock_fd, net_fd, optlen1, optval = 1;
  char optval1[TCP_CA_NAME_MAX];
  socklen_t remotelen;
  ...
  if(cliserv == CLIENT) {
    ...
    strcpy(optval1, "vegas");
    optlen1 = strlen(optval1);
    if (setsockopt(net_fd, IPPROTO_TCP, TCP_CONGESTION, optval1, optlen1) < 0) {
      perror("setsockopt");
      return 1;
    }
